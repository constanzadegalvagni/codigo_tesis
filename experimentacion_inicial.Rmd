...
m_hat = predict(y_forest, newdata=data.frame(X=x_grid) )$predictions
e_hat = predict(z_forest, newdata=data.frame(X=x_grid) )$predictions

cf_pred_no_tratados <- m_hat - e_hat * tau_cf
cf_pred_tratados <- m_hat + (1 - e_hat) * tau_cf
```
